...
import com.moko.lw001.databinding.Lw001DialogPasswordBinding;
import com.moko.lw001.utils.ToastUtils;

public class PasswordDialog extends BaseDialog<Lw001DialogPasswordBinding> {
    ...
    @Override
    protected Lw001DialogPasswordBinding getViewBind() {
        return Lw001DialogPasswordBinding.inflate(getLayoutInflater());
    }
