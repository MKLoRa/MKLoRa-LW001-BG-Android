...
import com.moko.lw001.databinding.Lw001DialogScanFilterBinding;

public class ScanFilterDialog extends com.moko.lw001.dialog.BaseDialog<Lw001DialogScanFilterBinding> {
    private int filterRssi;
    private String filterName;

    @Override
    protected Lw001DialogScanFilterBinding getViewBind() {
        return Lw001DialogScanFilterBinding.inflate(getLayoutInflater());
    }
