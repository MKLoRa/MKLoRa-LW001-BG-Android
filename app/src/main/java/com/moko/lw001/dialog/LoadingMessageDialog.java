...
import com.moko.lw001.databinding.Lw001DialogLoadingMessageBinding;
import com.moko.lw001.view.ProgressDrawable;

import androidx.annotation.StringRes;
import androidx.core.content.ContextCompat;

public class LoadingMessageDialog extends MokoBaseDialog<Lw001DialogLoadingMessageBinding> {
    ...
    @Override
    protected Lw001DialogLoadingMessageBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return Lw001DialogLoadingMessageBinding.inflate(inflater, container, false);
    }

    @Override
    protected void onCreateView() {
        ProgressDrawable progressDrawable = new ProgressDrawable();
        progressDrawable.setColor(ContextCompat.getColor(getContext(), R.color.lw001_text_black_4d4d4d));
...
//        }, DIALOG_DISMISS_DELAY_TIME);
    ...
    public int getDialogStyle() {
        return R.style.LW001CenterDialog;
    }
