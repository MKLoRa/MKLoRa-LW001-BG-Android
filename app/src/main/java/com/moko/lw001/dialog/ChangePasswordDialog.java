...
import com.moko.lw001.databinding.Lw001DialogChangePasswordBinding;
import com.moko.lw001.utils.ToastUtils;


public class ChangePasswordDialog extends com.moko.lw001.dialog.BaseDialog<Lw001DialogChangePasswordBinding> {
    ...
    @Override
    protected Lw001DialogChangePasswordBinding getViewBind() {
        return Lw001DialogChangePasswordBinding.inflate(getLayoutInflater());
    }
