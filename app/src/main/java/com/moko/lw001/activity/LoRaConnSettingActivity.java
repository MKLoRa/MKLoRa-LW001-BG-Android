...
import com.moko.lw001.dialog.LoginDialog;
import com.moko.lw001.dialog.LogoutDialog;
import com.moko.lw001.net.Urls;
import com.moko.lw001.net.entity.CommonResp;
import com.moko.lw001.net.entity.LoginEntity;
...
public class LoRaConnSettingActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    private Lw001ActivityConnSettingBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw001ActivityConnSettingBinding.inflate(getLayoutInflater());
                                ...
                                switch (configKeyEnum) {
                                    ...
                                    case KEY_LORA_UPLINK_STRATEGY:
                                        if (length > 0) {
                                            ...
                                            mBind.tvTransmissions.setText(mTransmissionsNumberList.get(mSelectedTransmissions));
    ...
    public void selectTransmissions(View view) {
        ...
        bottomDialog.setListener(value -> {
            ...
            mBind.tvTransmissions.setText(mTransmissionsNumberList.get(value));
        });
        bottomDialog.show(getSupportFragmentManager());
    }
    ...
    public void onSave(View view) {
        ...
        showSyncingProgressDialog();
        LoRaLW001MokoSupport.getInstance().sendOrder(mOrderTasks.toArray(new OrderTask[]{}));
    }
    ...
    private ArrayList<OrderTask> getOrderTasks() {
        ...
        orderTasks.add(OrderTaskAssembler.setLoraUplinkStrategy(mBind.cbAdr.isChecked() ? 1 : 0,
    ...
    private static final String DEVICE_PROFILE_TYPE = "001";
    private static final String APPLICATION_NAME = "LW001_BG";
    // LW001-BG PRO(L) 10
    // LW001-BG PRO(M) 20
    // LW004-PB 30
    // LW005-MP 40
    ...
    // LW007-PIR 50
    // LW008-MT 60
    private static final String PRODUCT_MODEL = "20";
