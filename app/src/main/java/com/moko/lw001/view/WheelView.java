...
public class WheelView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray attribute = context.obtainStyledAttributes(attrs, R.styleable.LW001WheelView);
        unitHeight = (int) attribute.getDimension(R.styleable.LW001WheelView_unitHeight, unitHeight);
        itemNumber = attribute.getInt(R.styleable.LW001WheelView_itemNumber, itemNumber);

        normalFont = attribute.getDimension(R.styleable.LW001WheelView_normalTextSize, normalFont);
        selectedFont = attribute.getDimension(R.styleable.LW001WheelView_selectedTextSize, selectedFont);
        normalColor = attribute.getColor(R.styleable.LW001WheelView_normalTextColor, normalColor);
        selectedColor = attribute.getColor(R.styleable.LW001WheelView_selectedTextColor, selectedColor);

        lineColor = attribute.getColor(R.styleable.LW001WheelView_lineColor, lineColor);
        lineHeight = attribute.getDimension(R.styleable.LW001WheelView_lineHeight, lineHeight);

        selectedBgColor = attribute.getColor(R.styleable.LW001WheelView_selectedBgColor, selectedBgColor);

        maskHeight = attribute.getDimension(R.styleable.LW001WheelView_maskHeight, maskHeight);
        noEmpty = attribute.getBoolean(R.styleable.LW001WheelView_noEmpty, true);
        isEnable = attribute.getBoolean(R.styleable.LW001WheelView_isEnable, true);
